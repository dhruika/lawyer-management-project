...
if (isset($_POST['update'])) {
    ...
    if (empty($current) || empty($new_password) || empty($confirm_password)) {
        ...
        $query = "SELECT password FROM user WHERE email = ? AND role = 'Client'";
        ...
        if ($user && password_verify($current, $user['password'])) {
            ...
            $update_query = "UPDATE user SET password = ? WHERE email = ? AND role = 'Client'";
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item ms-3">
                        <a class="nav-link btn gradient-btn" href="#">
                            <img src="images/upload/<?php echo $profile_image; ?>" alt="Profile" class="profile-img-nav" onerror="this.src='images/upload/default-profile.png'">
    ...
    <div class="d-flex" id="wrapper">
        <div class="bg-light border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="user_case_detail.php" class="list-group-item list-group-item-action bg-light">Case Details</a>
                <a href="user_document_management.php" class="list-group-item list-group-item-action bg-light">Document Management</a>
                <a href="update_password.php" class="list-group-item list-group-item-action bg-light active">
                    Update Password
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form autocomplete="off" method="post" action="update_password.php" class="needs-validation" novalidate>
